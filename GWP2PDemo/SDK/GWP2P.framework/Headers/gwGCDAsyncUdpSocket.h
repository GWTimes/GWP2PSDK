...
//
//  为避免和SDK外部使用的GCDAsyncUdpSocket产生冲突,类名和一些常量加了gw前缀
...
extern NSString *const gwGCDAsyncUdpSocketException;
extern NSString *const gwGCDAsyncUdpSocketErrorDomain;

extern NSString *const gwGCDAsyncUdpSocketQueueName;
extern NSString *const gwGCDAsyncUdpSocketThreadName;

enum gwGCDAsyncUdpSocketError
{
	gwGCDAsyncUdpSocketNoError = 0,          // Never used
	gwGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	gwGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	gwGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	gwGCDAsyncUdpSocketClosedError,          // The socket was closed
	gwGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
typedef enum gwGCDAsyncUdpSocketError gwGCDAsyncUdpSocketError;
 ...
 * 
**/
typedef BOOL (^gwGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id *context);
 ...
 *
**/
typedef BOOL (^gwGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface gwGCDAsyncUdpSocket : NSObject
...
**/
- (void)setSendFilter:(gwGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(gwGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(gwGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(gwGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
...
@protocol gwGCDAsyncUdpSocketDelegate
@optional
...
**/
- (void)udpSocket:(gwGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(gwGCDAsyncUdpSocket *)sock didNotConnect:(NSError *)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(gwGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(gwGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(gwGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(gwGCDAsyncUdpSocket *)sock withError:(NSError *)error;
