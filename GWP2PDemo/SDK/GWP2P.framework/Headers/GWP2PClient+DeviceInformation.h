//
/** @file GWP2PClient+DeviceInformation.h @brief 该文件为P2PClient获取和设置设备状态信息的分类 */
//  P2PSDK
//
 ...
 */
@interface GWP2PClient (DeviceInformation)
...
/**
 ...
 @param completionBlock         与设备交互完成后的回调Block
 */
- (void)getDeviceInformationWithDeviceID:(NSString *)deviceID
...
/**
 ...
 @param completionBlock 与设备交互完成后的回调Block
 */
- (void)backDevice4gBindNotifyWithDeviceID:(NSString *)deviceID
                            devicePassword:(NSString *)devicePassword
                           completionBlock:(CompletionBlock)completionBlock;
...
/**
 ...
 @param completionBlock         与设备交互完成后的回调Block
 */
- (void)getDeviceNVRInformationWithDeviceID:(NSString *)deviceID
                             devicePassword:(NSString *)devicePassword
                            completionBlock:(CompletionBlock)completionBlock;
